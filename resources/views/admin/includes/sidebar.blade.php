    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                @permission('read-basic_attributes')
                    <li class="menu-item menu-item-submenu {{ request()->routeIs('basic-attributes.*') ? 'menu-item-open menu-item-here' : '' }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <i class="fab fa-product-hunt svg-icon menu-icon"></i>
                            <span class="menu-text">{{ __('words.basic_attributes') }}</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                ...
                                @permission('read-basic_attributes')
                                    <li class="menu-item  {{ request()->routeIs('basic-attributes.index') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        <a href="{{ route('basic-attributes.index') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">{{ __('words.show_all') }}</span>
                                ...
                                @permission('create-basic_attributes')
                                    <li class="menu-item  {{ request()->routeIs('basic-attributes.create') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        <a href="{{ route('basic-attributes.create') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">{{ __('words.create') }}</span>
